...
async function createWarehouse(data,partnerId)
{
...
async function getWarehouse(partnerId)
{
    return Warehouse.find({"isDelete" : false,"partner_id": partnerId});
}

async function getWarehouseByCity(cityId,partnerId) {
   
    return Warehouse.find({"isDelete" : false, "partner_id": partnerId, "city.cityId" : parseInt(cityId)});
}
