...
async function createStore(data,partnerId)
{
...
async function getStore(partnerId)
{
    return Store.find({"isDelete": false, "partner_id": partnerId});
}

async function getStoreByWarehouseCityHub(warehouseId, cityId, hubId, partnerId)
{
    return Store.find({"isDelete": false, "warehouse.warehouseId" : parseInt(warehouseId),  "partner_id": partnerId, "city.cityId" : parseInt(cityId), "hub.hubId": parseInt(hubId)});
}

async function getStoreByWarehouse(warehouseId, partnerId)
{
    return Store.find({"isDelete" : false,  "partner_id": partnerId, "warehouse.warehouseId" : parseInt(warehouseId)});
}
...
module.exports = { createStore, getStore, editStore, deleteStore, getStoreByWarehouseCityHub, getStoreByWarehouse};
