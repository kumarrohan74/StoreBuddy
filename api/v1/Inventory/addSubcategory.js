...
async function createSubCategory(data,subCategoryImage,partnerId)
{
...
function getSubCategory(partnerId)
{
    return SubCategory.find({"isDelete" : false,"partner_id": partnerId});
}
